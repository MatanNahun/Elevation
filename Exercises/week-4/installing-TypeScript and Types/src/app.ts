...
class Student{
    ...
    getGradeAvg() : number{
        ...
        let average: number = sumGrades/(this.grades.length)
        return average
    }
}

const student1: Student = new Student("matan", [76,90,87,89])
const student2: Student = new Student("yaniv", [46,20])
const student3: Student = new Student("mal", [96,90])
